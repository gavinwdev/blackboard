...
Object(_view__WEBPACK_IMPORTED_MODULE_0__["directive"])('b-if', {
    ...
    onInserted: function (ele, binding) {
        if (!binding.compute()) {
            ...
            _utility__WEBPACK_IMPORTED_MODULE_1__["replace"](ele, this.comment);
        }
    },
    onUpdate: function (ele, binding) {
        if (binding.compute()) {
            if (this.comment) {
                _utility__WEBPACK_IMPORTED_MODULE_1__["replace"](this.comment, ele);
                this.comment = null;
            }
        }
        else {
    ...
    onInserted: function (ele, binding, com) {
        ...
        if(com == null){
           ele.addEventListener('change', function(e){
                _utility__WEBPACK_IMPORTED_MODULE_1__["setProperty"](binding.scope, binding.text, e.target.value);
           });
        }
        else{
            if(_utility__WEBPACK_IMPORTED_MODULE_1__["isMessenger"](com.change)){
                com.change.on(function(e, args){
                    _utility__WEBPACK_IMPORTED_MODULE_1__["setProperty"](binding.scope, binding.text, args.newvalue);
                });
            }
...
Object(_view__WEBPACK_IMPORTED_MODULE_0__["directive"])('b-repeat', function (ele) {
